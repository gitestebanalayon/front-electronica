...
import Alert from "./restorePassword/Alert.vue";
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <Form id="restore-password" class="modal-content" @submit="restorePassword" :validation-schema="schema"
                ...
                <div v-if="currentStep === 0" class="modal-body d-flex flex-column">
                    ...
                    <!-- Alerta de error -->
                    <Alert v-if="currentStep === 0 && useAccount.message && useAccount.status === 409" type="danger"
                        :title="useAccount.message" icon="danger" />
                </div>
                ...
                <div v-if="currentStep === 1" class="modal-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <button class="btn" type="button" :disabled="useAccount.isButtonDisabled"
                                ...
                                <div v-if="currentStep === 1 && useAccount.loading === 'sendCode'"
                    ...
                    <Alert v-if="currentStep === 1 && useAccount.message"
                        :type="useAccount.status === 200 ? 'success' : 'danger'" :title="useAccount.message"
                        :icon="useAccount.status === 200 ? 'check' : 'danger'" />
                </div>

                <div v-if="currentStep === 2" class="modal-body d-flex flex-column">
                    <Alert v-if="currentStep === 2" :type="useAccount.status === 200 ? 'success' : 'danger'"
                        title="Su contraseña a sido restaurada existosamente."
                        text="La nueva contraseña a sido enviada a su correo, por favor verifique su correo." />
                </div>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <!-- Button Loader -->
                    <button v-if="currentStep === 0" @click="verifyAccount()"
                        :disabled="useAccount.loading === 'verifyAccount'" class="btn btn-primary" type="submit">
                        <span v-if="useAccount.loading === null">Verificar</span>
                        <div v-if="useAccount.loading === 'verifyAccount'" class="spinner-border" role="status"></div>
                    </button>
                    ...
                    <button v-if="currentStep === 1" @click="restorePassword()"
                        :disabled="useAccount.loading === 'restorePassword'" class="btn btn-primary" type="submit">
                        <span v-if="useAccount.loading === 'sendCode' || useAccount.loading === null">Restaurar</span>
                        <div v-if="useAccount.loading === 'restorePassword'" class="spinner-border" role="status"></div>
                    </button>
